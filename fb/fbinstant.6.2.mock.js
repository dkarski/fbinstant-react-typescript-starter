...
var FBInstant = {
  ...
  player: {
    ...
    getPhoto: function () {
      return FBInstant.__utils.returnUserData('./img/fb/profile.png');
    },
    getID: function () {
          ...
          players = [
            {
              ...
              getPhoto: function () { return './img/fb/friend1.png'; }
            },
            {
              getID: function () { return '43'; },
              getName: function () { return 'Friend 2'; },
              getPhoto: function () { return './img/fb/friend2.png'; }
            },
            {
              getID: function () { return '44'; },
              getName: function () { return 'Friend 3'; },
              getPhoto: function () { return './img/fb/friend3.png'; }
            }
          ];
        } else {
  ...
  getEntryPointData: function () {
    ...
    if (queryString.entryPointData) {
      ...
      FBInstant.__utils.log(
        'While using the fb SDK, set your entryPointData in the URL',
  ...
  setSessionData: function (object) {
    FBInstant.log(
      ...
      object,
      '(Please note, while using the fb SDK, '+
    ...
    var leaderboard = {
      ...
      setScoreAsync: function (score, extraData) {
        var leaderboardEntry = FBInstant.__utils.createLeaderboardEntry(
          score,
          3,
          {name: 'Player 1', photo: './img/fb/profile.png', id: 123456789},
          extraData
        );
